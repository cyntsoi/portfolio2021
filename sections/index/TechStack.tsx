...
const TechStack: FC<IProps> = ({ subheading, body, technologies }) => {
  ...
  return (
    <Box as="section" id="tech-stack" className="bg-tint">
      <Container pt={{ md: 36, base: 20 }} pb={{ md: 44, base: 12 }}>
        ...
        >
          <GridItem
            colStart={{ base: 2, md: 3, lg: 4 }}
            colSpan={{ base: 10, md: 8, lg: 6 }}
            textAlign="center"
          >
            <Heading as="p" variant="subheading" mb={{ base: 14, md: 28 }}>
              {subheading}
            </Heading>
                  ...
                  <Fragment key={tech.id}>
                    ...
                    >
                      ...
                      <Text
                        ...
                        pb={5}
                      >
                        {tech.shortName ? tech.shortName : tech.name}
                      </Text>
                    </GridItem>
                    {isActive && (
                      <GridItem colSpan={24}>
...
TechStack.defaultProps = {
  subheading:
    'This is a quick summary of my stack. This is a quick summary of my stack. This is a quick summary of my stack. This is a quick summary of my stack. This is a quick summary of my stack.',
