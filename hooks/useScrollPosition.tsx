    ...
    useEffect(() => {
        ...
        function handleScroll() {
            ...
            requestAnimationFrame(() => {
                setScrollPos(({current}) => ({previous: current, current: window.scrollY}))
...
export const ScrollPositionProvider : FC<PropsWithChildren<{}>> = ({children}) => {
    ...
    return <ScrollPositionContext.Provider value={scrollPos}>{children}</ScrollPositionContext.Provider>
}
